/*=========================================================================
DO FILE NAME:			12_sccs_subgroup_analysis_byclass
...
DESCRIPTION OF FILE:	Runs SCCS, adjusting for other classes of antihypertensives used
*=========================================================================*/

* create new log
cap log close
log using "${logfiles}/12_sccs_subgroup_analysis_byclass_${drug}_${outcome}", text replace

/*****************************************************************
Create SCCS datasets with flags for other antihyps used during intervals
*****************************************************************/
...
save "$datafile\\sccs_subgroup_analysis_dataset_${drug}_${outcome}", replace

/*****************************************************************
Set up excel
*****************************************************************/

putexcel set "$output/sccs_subgroup_analysis_byclass.xlsx", sheet("${drug}") modify
...
if "${drug}" == "allclasses" {	
local antihypadjust i.multiple_drug
}
