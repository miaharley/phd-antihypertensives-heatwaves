/*=========================================================================
DO FILE NAME:			8_create_noantihyp_heatwave_intervals
...
Aim: 					Identify exposure intervals for heatwaves among people who were not exposed to drugs during study period
*=============================================================================*/

* create new log
cap log close
log using "${logfiles}/8_create_noantihyp_heatwave_intervals", text replace

/*****************************************************************
* 1. Create exposure intervals
*****************************************************************/	

* People with hypertension who experienced heatwave and were never prescribed drug
use "$datafile/hypertension_heatwave_${drug}_noantihyp", clear
...
save "$datafile/hypertension_${drug}_noantihyp_heatwave_intervals", replace

/*****************************************************************/
* 4. append the antihyp dataset and noantihyp dataset for SCCS
*****************************************************************/
use "$datafile/hypertension_${drug}_antihyp_heatwave_intervals", clear
append using "$datafile/hypertension_${drug}_noantihyp_heatwave_intervals"

keep patid intertype st_st st_en interstart interend dob season month age_gp drugexposed
order patid dob st_st st_en intertype interstart interend season month age_gp drugexposed

duplicates drop patid intertype st_st st_en interstart interend dob season month age_gp drugexposed, force

gen unique_interval = _n

save "$datafile/hypertension_${drug}_heatwave_intervals_all", replace
